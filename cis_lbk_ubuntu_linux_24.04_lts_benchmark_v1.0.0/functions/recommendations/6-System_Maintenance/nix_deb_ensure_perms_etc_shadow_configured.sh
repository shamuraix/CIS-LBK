...
#
# # START METADATA
#   recommendation = 18ac336a
#   function = deb_ensure_perms_etc_shadow_configured
#   applicable =
# # END METADATA
#
#
# CIS-LBK Cloud Team Built Recommendation Function
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_perms_etc_shadow_configured.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Justin Brown       11/09/22     Recommendation "Ensure permissions on /etc/shadow are configured"

deb_ensure_perms_etc_shadow_configured()
{
	...
	deb_ensure_perms_etc_shadow_configured_chk()
	{
	...
	deb_ensure_perms_etc_shadow_configured_fix()
	{
