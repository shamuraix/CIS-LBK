...
#
# # START METADATA
#   recommendation = 36260b56
#   function = deb_ensure_perms_etc_gshadow_configured
#   applicable =
# # END METADATA
#
#
# CIS-LBK Cloud Team Built Recommendation Function
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_perms_etc_gshadow_configured.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Justin Brown       11/09/22     Recommendation "Ensure permissions on /etc/gshadow are configured"

deb_ensure_perms_etc_gshadow_configured()
{
	...
	deb_ensure_perms_etc_gshadow_configured_chk()
	{
	...
	deb_ensure_perms_etc_gshadow_configured_fix()
	{
