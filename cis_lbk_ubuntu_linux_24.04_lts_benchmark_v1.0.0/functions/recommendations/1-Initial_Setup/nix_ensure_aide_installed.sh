...
#
# # START METADATA
#   recommendation = 99347f49
#   function = ensure_aide_installed
#   applicable =
# # END METADATA
#
#
...
# David Neilson		 04/06/24	 Changed "$G_PM -y install" to "$G_PM install -y", check $l_output before running $G_PQ command, and updated to run on Suse.
