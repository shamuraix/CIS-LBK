...
#
# # START METADATA
#   recommendation = a272fa5b
#   function = ensure_udf_kernel_module_not_available
#   applicable =
# # END METADATA
#
#
...
# ~/CIS-LBK/functions/recommendations/nix_ensure_udf_kernel_module_not_available.sh
#
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       05/06/20    Recommendation "Ensure udf kernel module is not available"
...
# David Neilson      10/03/23    Changed "install " to "install\h+", and set l_test="remediated" if second run of ensure_udf_filesystem_disabled_chk succeeds.
# David Neilson      07/27/24    Updated to latest benchmark.

ensure_udf_kernel_module_not_available()
{
    ...
    ensure_udf_kernel_module_not_available_chk()
    {
    ...
    ensure_udf_kernel_module_not_available_fix()
    {
