...
#
# # START METADATA
#   recommendation = e297df3e
#   function = ensure_usb_storage_kernel_module_not_available
#   applicable =
# # END METADATA
#
#
...
# ~/CIS-LBK/functions/recommendations/nix_ensure_usb_storage_kernel_module_not_available.sh
#
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       09/11/20    Recommendation "Ensure usb-storage kernel module is not available"
# Justin Brown       07/31/22    Updated to modern format
# Justin Brown       06/21/23    Update to add type support
# David Neilson      07/30/24    Updated to latest benchmark.  Fixed lsmod command looking for "usb_storage"

ensure_usb_storage_kernel_module_not_available()
{
    ...
    f_module_chk()
    {
        ...
        if ! lsmod | grep -P -- "${l_mod_name//-/_}\b" &> /dev/null; then # Check if the module is currently loaded
    ...
    ensure_usb_storage_kernel_module_not_available_chk()
    {
    ...
    ensure_usb_storage_kernel_module_not_available_fix()
    {
