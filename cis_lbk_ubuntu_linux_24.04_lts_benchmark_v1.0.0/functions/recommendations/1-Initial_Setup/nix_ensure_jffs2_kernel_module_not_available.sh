...
#
# # START METADATA
#   recommendation = 20ff58d3
#   function = ensure_jffs2_kernel_module_not_available
#   applicable =
# # END METADATA
#
#
...
# ~/CIS-LBK/functions/recommendations/nix_ensure_jffs2_kernel_module_not_available.sh
#
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       05/06/20    Recommendation "Ensure jffs2 kernel module is not available"
...
ensure_jffs2_kernel_module_not_available()
{
    ...
    ensure_jffs2_kernel_module_not_available_chk()
    {
    ...
    ensure_jffs2_kernel_module_not_available_fix()
    {
