...
#
# # START METADATA
#   recommendation = 7211a8af
#   function = ensure_hfs_kernel_module_not_available
#   applicable =
# # END METADATA
#
#
# CIS-LBK _Main Recommendation Function
# ~/CIS-LBK/functions/recommendations/nix_ensure_hfs_kernel_module_not_available.sh
#
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Justin Brown       06/21/23    Recommendation "Ensure hfs kernel module is not available"
# David Neilson      07/27/24    Updated to latest benchmark.  

ensure_hfs_kernel_module_not_available()
{
    ...
    ensure_hfs_kernel_module_not_available_chk()
    {
    ...
    ensure_hfs_kernel_module_not_available_fix()
    {
