...
#
# # START METADATA
#   recommendation = 926dfe7c
#   function = ensure_hfsplus_kernel_module_not_available
#   applicable =
# # END METADATA
#
#
...
# ~/CIS-LBK/functions/recommendations/nix_ensure_hfsplus_kernel_module_not_available.sh
#
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Justin Brown       06/21/23    Recommendation "Ensure hfsplus kernel module is not available"
# David Neilson      07/27/24    Updated to latest benchmark.


ensure_hfsplus_kernel_module_not_available()
{
    ...
    ensure_hfsplus_kernel_module_not_available_chk()
    {
    ...
    ensure_hfsplus_kernel_module_not_available_fix()
    {
