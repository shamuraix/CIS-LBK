...
#
# # START METADATA
#   recommendation = e8f74861
#   function = ensure_cramfs_kernel_module_not_available
#   applicable =
# # END METADATA
#
#
...
# ~/CIS-LBK/functions/recommendations/nix_ensure_cramfs_kernel_module_not_available.sh
#
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       05/06/20    Recommendation "Ensure cramfs kernel module is not available"
# Justin Brown		   07/20/22    Updated to modern format
# Justin Brown       06/21/23    Update to add type support
# Randie Bejar       09/14/23    Updated filesystem disabled chk
# David Neilson      07/11/24    Updated to latest benchmark.  

ensure_cramfs_kernel_module_not_available()
{
    ...
    ensure_cramfs_kernel_module_not_available_chk()
    {
    ...
    ensure_cramfs_kernel_module_not_available_fix()
    {
