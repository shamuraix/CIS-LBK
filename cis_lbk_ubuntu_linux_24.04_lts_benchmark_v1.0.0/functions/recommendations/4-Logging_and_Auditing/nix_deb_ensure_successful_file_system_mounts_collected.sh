...
#   function = deb_ensure_successful_file_system_mounts_collected
#   applicable =
# # END METADATA
#
#
# CIS-LBK Recommendation Function
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_successful_file_system_mounts_collected.sh
# 
...
deb_ensure_successful_file_system_mounts_collected()
{
	echo
	...
	deb_ensure_successful_file_system_mounts_collected_fix()
	{
