...
#
# # START METADATA
#   recommendation = a8db16a6
#   function = deb_ensure_events_modify_systems_network_environment_collected
#   applicable =
# # END METADATA
#
#
# CIS-LBK Recommendation Function
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_events_modify_systems_network_environment_collected.sh
# 
...
# David Neilson      03/28/23    Made deb- only to reference /etc/network* 
# David Neilson		 05/29/23	 Resolved issue with not working with auditctl.

deb_ensure_events_modify_systems_network_environment_collected()
{
	echo
	echo -e "\n**************************************************\n- $(date +%d-%b-%Y' '%T)\n- Start Recommendation \"$RN - $RNA\"" | tee -a "$LOG" 2>> "$ELOG"
	l_test=""
	l_uid_min=""
	l_locales="issue issue.net hosts networks network netplan"
	...
	deb_ensure_events_modify_systems_network_environment_collected_chk()
	{
	...
	deb_ensure_events_modify_systems_network_environment_collected_fix()
	{
