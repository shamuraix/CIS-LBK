...
#
# # START METADATA
#   recommendation = a424f9ad
#   function = deb_ensure_successful_and_unsuccessful_use_of_usermod_commands_recorded
#   applicable =
# # END METADATA
#
#
# CIS-LBK Recommendation Function
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_successful_and_unsuccessful_use_of_usermod_commands_recorded.sh
# 
...
deb_ensure_successful_and_unsuccessful_use_of_usermod_commands_recorded()
{
	echo
	...
	deb_ensure_successful_and_unsuccessful_use_of_usermod_commands_recorded_chk()
	{
	...
	deb_ensure_successful_and_unsuccessful_use_of_usermod_commands_recorded_fix()
	{
