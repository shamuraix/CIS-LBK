...
#
# # START METADATA
#   recommendation = 9ae25c4f
#   function = ensure_events_modify_date_time_information_collected
#   applicable =
# # END METADATA
#
#
...
# David Neilson      06/09/23    Minor regex change to rule_line=
# David Neilson		 02/29/24	 Determines the flavor of the OS and adds "stime" to the system calls for 32-bit Suse
...
ensure_events_modify_date_time_information_collected()
{
	...
	ensure_events_modify_date_time_information_collected_chk()
	{
		...
		# For Suse 32 bit systems, the System call includes "stime"
		[ "$l_system_flavor" = "suse" ] && l_rule_1=$l_rule_1",stime"
