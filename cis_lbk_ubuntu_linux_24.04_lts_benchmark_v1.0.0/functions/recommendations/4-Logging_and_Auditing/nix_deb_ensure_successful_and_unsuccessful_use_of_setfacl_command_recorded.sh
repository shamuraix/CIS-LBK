...
#
# # START METADATA
#   recommendation = 511b4b1b
#   function = deb_ensure_successful_and_unsuccessful_use_of_setfacl_command_recorded
#   applicable =
# # END METADATA
#
#
# CIS-LBK Recommendation Function
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_successful_and_unsuccessful_use_of_setfacl_command_recorded.sh
# 
...
deb_ensure_successful_and_unsuccessful_use_of_setfacl_command_recorded()
{
	echo
	...
	deb_ensure_successful_and_unsuccessful_use_of_setfacl_command_recorded_chk()
	{
	...
	deb_ensure_successful_and_unsuccessful_use_of_setfacl_command_recorded_fix()
	{
