...
#
# # START METADATA
#   recommendation = 8dcc9cfd
#   function = ensure_actions_another_user_always_logged
#   applicable =
# # END METADATA
#
#
...
ensure_actions_another_user_always_logged()
{
    ...
    ensure_actions_as_another_user_logged_chk()
	{
	...
	ensure_actions_as_another_user_logged_fix()
	{
