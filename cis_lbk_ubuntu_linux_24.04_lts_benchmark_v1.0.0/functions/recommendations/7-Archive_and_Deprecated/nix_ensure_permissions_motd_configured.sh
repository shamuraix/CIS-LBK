...
#
# # START METADATA
#   recommendation = 50276e72
#   function = ensure_permissions_motd_configured
#   applicable =
# # END METADATA
#
#
...
# J Brown				04/03/24		This script will be deprecated and replaced by 'nix_ensure_access_etc_motd_configured.sh'
