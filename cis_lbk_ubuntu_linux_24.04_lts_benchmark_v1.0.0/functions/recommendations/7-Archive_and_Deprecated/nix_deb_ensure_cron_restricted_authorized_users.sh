...
#
# # START METADATA
#   recommendation = a4a5c0bc
#   function = deb_ensure_cron_restricted_authorized_users
#   applicable =
# # END METADATA
#
#
# CIS-LBK Deprecated Recommendation Function
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_cron_restricted_authorized_users.sh
#
# Name                	Date       		Description
# ------------------------------------------------------------------------------------------------
# Justin Brown       	11/12/22    	Recommendation "Ensure cron is restricted to authorized users"
# J Brown               02/21/24        This script will be deprecated and replaced by 'nix_ensure_crontab_restricted_authorized_users.sh'
#


deb_ensure_cron_restricted_authorized_users()
{
	...
	deb_ensure_cron_restricted_authorized_users_chk()
	{
	...
	deb_ensure_cron_restricted_authorized_users_fix()
	{
