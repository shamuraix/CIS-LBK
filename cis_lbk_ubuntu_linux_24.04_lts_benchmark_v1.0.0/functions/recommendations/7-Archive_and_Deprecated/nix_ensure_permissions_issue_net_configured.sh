...
#
# # START METADATA
#   recommendation = d0a52105
#   function = ensure_permissions_issue_net_configured
#   applicable =
# # END METADATA
#
#
...
# J Brown				04/03/24		This script will be deprecated and replaced by 'nix_ensure_access_etc_issue_net_configured.sh'
#
