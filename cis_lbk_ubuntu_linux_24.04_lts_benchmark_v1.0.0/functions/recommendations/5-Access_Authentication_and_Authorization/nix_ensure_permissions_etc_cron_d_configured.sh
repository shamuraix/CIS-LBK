...
#
# # START METADATA
#   recommendation = 1db648e2
#   function = ensure_permissions_etc_cron_d_configured
#   applicable =
# # END METADATA
#
#
# CIS-LBK _Main Recommendation Function
# ~/CIS-LBK/functions/recommendations/nix_ensure_permissions_etc_cron_d_configured.sh
#
# Name                  Date            Description
# --------------------------------------------------------------------------------------------------------
# J Brown               02/21/24        Recommendation "Ensure permissions on /etc/cron.d are configured"
...
ensure_permissions_etc_cron_d_configured()
{
	echo -e "\n**************************************************\n- $(date +%d-%b-%Y' '%T)\n- Start Recommendation \"$RN - $RNA\"" | tee -a "$LOG" 2>> "$ELOG"
    l_test="" l_pkg=""
    l_cron_dir="/etc/cron.d/"
	...
	ensure_permissions_etc_cron_d_configured_chk()
	{
	...
	ensure_permissions_etc_cron_d_configured_fix()
	{
