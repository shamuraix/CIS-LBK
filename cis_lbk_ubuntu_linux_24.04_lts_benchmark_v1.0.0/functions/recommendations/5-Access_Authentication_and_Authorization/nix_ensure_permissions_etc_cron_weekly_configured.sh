...
#
# # START METADATA
#   recommendation = 005bda96
#   function = ensure_permissions_etc_cron_weekly_configured
#   applicable =
# # END METADATA
#
#
# CIS-LBK _Main Recommendation Function
# ~/CIS-LBK/functions/recommendations/nix_ensure_permissions_etc_cron_weekly_configured.sh
#
# Name                  Date            Description
# --------------------------------------------------------------------------------------------------------
# J Brown               02/21/24        Recommendation "Ensure permissions on /etc/cron.weekly are configured"
...
ensure_permissions_etc_cron_weekly_configured()
{
	echo -e "\n**************************************************\n- $(date +%d-%b-%Y' '%T)\n- Start Recommendation \"$RN - $RNA\"" | tee -a "$LOG" 2>> "$ELOG"
    l_test="" l_pkg=""
    l_cron_dir="/etc/cron.weekly/"
	...
	ensure_permissions_etc_cron_weekly_configured_chk()
	{
	...
	ensure_permissions_etc_cron_weekly_configured_fix()
	{
