...
#
# # START METADATA
#   recommendation = e88592fd
#   function = ensure_permissions_etc_cron_hourly_configured
#   applicable =
# # END METADATA
#
#
# CIS-LBK _Main Recommendation Function
# ~/CIS-LBK/functions/recommendations/nix_ensure_permissions_etc_cron_hourly_configured.sh
#
# Name                  Date            Description
# --------------------------------------------------------------------------------------------------------
# J Brown               02/21/24        Recommendation "Ensure permissions on /etc/cron.hourly are configured"
# David Neilson         06/26/24        Set l_test variable instead of running the "return" command if package manager is unknown or cron not installed, changed references of "0600" to "0700", and changed variable "cron_dir" to "l_cron_dir".


ensure_permissions_etc_cron_hourly_configured()
{
	echo -e "\n**************************************************\n- $(date +%d-%b-%Y' '%T)\n- Start Recommendation \"$RN - $RNA\"" | tee -a "$LOG" 2>> "$ELOG"
    l_test="" l_pkg=""
    l_cron_dir="/etc/cron.hourly/"
	...
	ensure_permissions_etc_cron_hourly_configured_chk()
	{
