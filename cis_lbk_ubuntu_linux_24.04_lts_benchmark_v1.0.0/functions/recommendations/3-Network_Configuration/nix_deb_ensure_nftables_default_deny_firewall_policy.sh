...
#
# # START METADATA
#   recommendation = d4220bad
#   function = deb_ensure_nftables_default_deny_firewall_policy
#   applicable =
# # END METADATA
#
...
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_nftables_default_deny_firewall_policy.sh
# 
...
deb_ensure_nftables_default_deny_firewall_policy()
{
	...
	deb_ensure_nftables_default_deny_firewall_policy_chk()
	{
	...
	deb_ensure_nftables_default_deny_firewall_policy_fix()
	{
