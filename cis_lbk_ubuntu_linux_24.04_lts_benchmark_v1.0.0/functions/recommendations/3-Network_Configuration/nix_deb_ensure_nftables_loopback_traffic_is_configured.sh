...
#   function = deb_ensure_nftables_loopback_traffic_is_configured
#   applicable =
# # END METADATA
#
...
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_nftables_loopback_traffic_is_configured.sh
# 
...
deb_ensure_nftables_loopback_traffic_is_configured()
{
   ...
   ipv6_chk()
   {
	...
	deb_ensure_nftables_loopback_traffic_is_configured_chk()
	{
	...
	deb_ensure_nftables_loopback_traffic_is_configured_fix()
	{
