...
#
# # START METADATA
#   recommendation = 94500021
#   function = deb_ensure_nftables_installed
#   applicable =
# # END METADATA
#
...
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_nftables_installed.sh
#
...
deb_ensure_nftables_installed()
{
	...
	deb_ensure_nftables_installed_chk()
	{
