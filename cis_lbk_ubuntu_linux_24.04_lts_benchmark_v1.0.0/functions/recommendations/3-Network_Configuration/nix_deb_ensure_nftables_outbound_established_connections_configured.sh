...
#
# # START METADATA
#   recommendation = 69cee336
#   function = deb_ensure_nftables_outbound_established_connections_configured
#   applicable =
# # END METADATA
#
...
# ~/CIS-LBK/functions/recommendations/nix_deb_ensure_nftables_outbound_established_connections_configured.sh
# 
...
deb_ensure_nftables_outbound_established_connections_configured()
{
	...
	deb_ensure_nftables_outbound_established_connections_configured_chk()
	{
	...
	deb_ensure_nftables_outbound_established_connections_configured_fix()
	{
